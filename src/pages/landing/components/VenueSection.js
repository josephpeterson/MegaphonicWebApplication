...
class VenueSection extends Component {
  ...
  render() {
    return (
			<section id="venues" className="venues-section bg-light">
				...
				<div className="row align-items-center no-gutters mb-4 mb-lg-5">
					...
					<div className="col-xl-4 col-lg-5">
						<div className="featured-text text-center text-lg-left">
							<h4>Artists</h4>
							<p className="text-black-50 mb-0">Grayscale is open source and MIT licensed. This means you can use it for any project - even commercial venues! Download it, customize it, and publish your website!</p>
						</div>
					</div>
				</div>
						...
						<div className="bg-black text-center h-100 project">
							<div className="d-flex h-100">
								<div className="project-text w-100 my-auto text-center text-lg-left">
									<h4 className="text-white">Share Music</h4>
						...
						<div className="bg-black text-center h-100 project">
							<div className="d-flex h-100">
								<div className="project-text w-100 my-auto text-center text-lg-right">
									<h4 className="text-white">Book Shows</h4>
